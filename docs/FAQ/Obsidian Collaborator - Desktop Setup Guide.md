...
_Before you can enter the secure system, you need a digital key. We use GitHub to store our data securely._
...
3. **Generate Your "Access Token" (PAT):**
    ...
    6. **Expiration:** Set to "No expiration" (easiest) or "90 days".
