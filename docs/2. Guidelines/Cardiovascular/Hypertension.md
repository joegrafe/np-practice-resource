...
- **Initiate pharmacotherapy**: For BP ≥140/90 mm Hg, or ≥130/80 mm Hg in high cardiovascular risk patients
- **First-line therapy**: Low-dose single-pill combination from two complementary classes (ACEI/ARB + thiazide/thiazide-like diuretic + long-acting CCB)
- **Resistant hypertension**: Spironolactone recommended as fourth-line agent

**Lifestyle Modifications**
- Recommended for all adults with hypertension
